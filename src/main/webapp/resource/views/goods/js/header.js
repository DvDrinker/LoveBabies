...
//		console.log(classifications);
		...
		if(HLisBtns[_index].isRequest == false) {
			...
			$.ajax({
				type:"get",
				url:"http://10.80.13.43:8080/classify/findClassify.do",
...
$.ajax({
	type:"get",
	url:"http://10.80.13.43:8080/classify/findFirstClassify.do",
...
$.ajax({
	type:"get",
	url:"http://10.80.13.43:8080/hot/selectHotName.do",
	data:{},
	async:true,
	success:function(data) {
...
if(userId != undefined) {
	$.ajax({
		type:"get",
		url:"http://10.80.13.43:8080/user/select.do",
		data:{userId: userId},
		dataType:"json",
		async:true,
		success:function(data) {
